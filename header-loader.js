...
// Инициализация функционала шапки (фиксация при скролле + бургер-меню)
function initHeader() {
...
// Функция для исправления иконки Telegram после загрузки шапки
function fixTelegramIcon() {
    const telegramLink = document.querySelector('.header-telegram');
    if (telegramLink) {
        // Заменяем старую иконку на новую
        telegramLink.innerHTML = `<svg viewBox="0 0 24 24" width="20" height="20" fill="white">
